...
<div style="height:100%;width:100%;padding-top:20px;">
	<table id="addModelTab" class="dlgtabStyle" cellpadding="10" cellspacing="25">
	<tr>
		...
		<tr>
			<!-- <input type="text" class="form-control" id="name" placeholder="请输入名称"> -->
			<td height="45px" width="25%">机顶盒型号:</td><td width="75%"><input type="text" class="form-control" name="modelname"/></td>
		</tr>
		<tr>
	...
	<a href="javascript:;" onclick="addModelSubmit();" class="dlgbtn">提交</a>
	<span id="ipterr"></span>
</div>
<script>
$(function(){
